...
Tell me: industry + content type to get started!`,
  },
  {
    ...
    description: "Sends email & WhatsApp sequences via Brevo — welcome, follow-ups, meeting reminders.",
    intro: `Hi! I'm Max 📧 — your Outreach Agent.

I run all automated email sequences via **Brevo SMTP** — welcome emails, follow-ups, and meeting reminders.

**What I handle:**
- **New lead** → welcome email immediately + follow-ups at 24h, 3d, 7d, 15d
- **Meeting scheduled** → reminder emails to the lead (3d / 24h / 1h before) + reminders to you
- **All sequences** include a Google Meet booking link and intake form link
- Emails are stored in \`outreach_schedule\` and sent by the cron job every 30 min

**Email platform:** Brevo (300 free emails/day) — configured via SMTP_HOST, SMTP_USER, SMTP_PASS

**Cron:** cron-job.org hits \`/api/cron\` every 30 minutes and sends any due emails.

Ask me anything about your outreach sequences!`,
  },
  {
    id: "cal",
    name: "Cal",
